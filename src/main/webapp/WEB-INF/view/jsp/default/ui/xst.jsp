<%@ page pageEncoding="UTF-8" language="java" import="com.gionee.util.ClientUtil" %>
    ...
    <div class="login-log">
      <form:form method="post" id="fm1" commandName="${commandName}" htmlEscape="true">
        ...
        <p class="input-com-t verify">
		  ...
		  <input class="login-input-t fl" type="text" id="j_captcha_response" name="j_captcha_response" />
        ...
        <p class="log">
          ...
          <a class="telp" style="padding-right:100px;" href="http://xst.gionee.com/client.html">销售通手机端下载</a> <a class="telp" href="http://www.baidu.com/s?ie=UTF-8&amp;wd=chrome">建议浏览器</a> </p>
...
<script type="text/javascript">
  $(function(){
    ...
    $('#j_captcha_response').attr('placeholder', '验证码');
	if (!$('#password').val()) {
	  $('#password').focus();
	}
	if (!$('#username').val()) {
